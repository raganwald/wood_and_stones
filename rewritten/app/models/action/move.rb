class Action::Move < Action::Gameplay
  ...
  def location
    @location ||= (__126695498571208__ = self.position
    if __126695498571208__.kind_of?(String) then
      RewriteRails::ExtensionMethods::String.to_location(__126695498571208__)
    else
      __126695498571208__.to_location
    end)
  end
  def removed
  ...
  def place_stone
    (dead_stones = (__126695498454834__ = self.before.legal_moves_for(self.player).detect do |its|
      (its.location == self.location)
    end and __126695498454834__.dead_stones) and (self.removed = dead_stones
