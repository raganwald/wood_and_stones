class Action::Gameplay < Action::Base
  ...
  def clone_game_board_to_before
    self.before ||= (__126393648089519__ = self.game and __126393648089519__.current_board)
    true
  end
  def clone_before_to_after
    self.after ||= (__126393648026105__ = self.before and __126393648026105__.clone)
    true
  end
