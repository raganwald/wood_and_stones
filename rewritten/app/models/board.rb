      ...
      def stone_positions
        stone_locations.map do |one_colour|
          one_colour.map do |one_location|
            __126780564277451__ = one_location
            if __126780564277451__.kind_of?(Array) then
              RewriteRails::ExtensionMethods::Array.to_position(__126780564277451__)
            else
              __126780564277451__.to_position
            end
          end
        end
      end
