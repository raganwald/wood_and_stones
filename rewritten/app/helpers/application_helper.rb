  ...
  def tile_class_array(board, valids)
    valids.inject(board.map_array(TILE_IMG_CLASS_MAP)) do |classes, its|
      lambda do |cc|
        ...
        pos = (__126746556082838__ = its.location
        if __126746556082838__.kind_of?(Array) then
          RewriteRails::ExtensionMethods::Array.to_position(__126746556082838__)
        else
          __126746556082838__.to_position
        end)
