  ...
  def tile_class_array(board, valids)
    valids.inject(board.map_array(TILE_IMG_CLASS_MAP)) do |classes, its|
      lambda do |cc|
        ...
        pos = (__126720032556401__ = its.location
        if __126720032556401__.kind_of?(Array) then
          RewriteRails::ExtensionMethods::Array.to_position(__126720032556401__)
        else
          __126720032556401__.to_position
        end)
