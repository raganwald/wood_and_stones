  ...
  def tile_class_array(board, valids)
    valids.inject(board.map_array(TILE_IMG_CLASS_MAP)) do |classes, its|
      lambda do |cc|
        ...
        pos = (__126721707932599__ = its.location
        if __126721707932599__.kind_of?(Array) then
          RewriteRails::ExtensionMethods::Array.to_position(__126721707932599__)
        else
          __126721707932599__.to_position
        end)
