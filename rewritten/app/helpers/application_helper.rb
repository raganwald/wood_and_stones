  ...
  def tile_class_array(board, valids)
    valids.inject(board.map_array(TILE_IMG_CLASS_MAP)) do |classes, its|
      lambda do |cc|
        ...
        pos = (__126754966766386__ = its.location
        if __126754966766386__.kind_of?(Array) then
          RewriteRails::ExtensionMethods::Array.to_position(__126754966766386__)
        else
          __126754966766386__.to_position
        end)
