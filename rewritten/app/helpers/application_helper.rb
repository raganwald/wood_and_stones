  ...
  def tile_class_array(board, valids)
    valids.inject(board.map_array(TILE_IMG_CLASS_MAP)) do |classes, its|
      lambda do |cc|
        ...
        pos = (__126766154753904__ = its.location
        if __126766154753904__.kind_of?(Array) then
          RewriteRails::ExtensionMethods::Array.to_position(__126766154753904__)
        else
          __126766154753904__.to_position
        end)
