  ...
  def tile_class_array(board, valids)
    valids.inject(board.map_array(TILE_IMG_CLASS_MAP)) do |classes, its|
      lambda do |cc|
        ...
        pos = (__126695787270008__ = its.location
        if __126695787270008__.kind_of?(Array) then
          RewriteRails::ExtensionMethods::Array.to_position(__126695787270008__)
        else
          __126695787270008__.to_position
        end)
