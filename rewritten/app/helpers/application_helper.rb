  ...
  def tile_class_array(board, valids)
    valids.inject(board.map_array(TILE_IMG_CLASS_MAP)) do |classes, its|
      lambda do |cc|
        ...
        pos = (__126723922797287__ = its.location
        if __126723922797287__.kind_of?(Array) then
          RewriteRails::ExtensionMethods::Array.to_position(__126723922797287__)
        else
          __126723922797287__.to_position
        end)
