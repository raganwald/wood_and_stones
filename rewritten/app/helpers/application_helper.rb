  ...
  def tile_class_array(board, valids)
    valids.inject(board.map_array(TILE_IMG_CLASS_MAP)) do |classes, its|
      lambda do |cc|
        ...
        pos = (__126721563726977__ = its.location
        if __126721563726977__.kind_of?(Array) then
          RewriteRails::ExtensionMethods::Array.to_position(__126721563726977__)
        else
          __126721563726977__.to_position
        end)
